...
class BaseRepository implements BaseRepositoryInterface
{
    ...
    public function paginate(int $limit, string $orderBy = 'id', string $sortBy = 'asc', int $category = 0)
    {
        if ($category != 0) {
            return $this->model->where('category_id', $category)->orderby($orderBy, $sortBy)->paginate($limit);
        }
